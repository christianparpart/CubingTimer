...
if(ENABLE_TIDY)
    ...
    if(NOT CLANG_TIDY_EXE)
        ...
        set(CMAKE_CXX_CLANG_TIDY
            "${CLANG_TIDY_EXE}"
            "--header-filter=${CMAKE_SOURCE_DIR}/src/(CubingCore|CubingDB|CubingTimer)/.*")
    endif()
else()
    message(STATUS "[clang-tidy] Disabled.")
endif()

# Helper: silence clang-tidy on a target. Useful for generated/fetched code
# (Catch2, autogen MOC, QML cache loaders) where the diagnostics don't apply.
function(cubingtimer_disable_tidy target)
